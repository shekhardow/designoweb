                ...
                <div class="col-md-7">
                    <div class="customerRight boxs">
                        ...
                        <!-- <?php // echo do_shortcode('[contact-form-7 id="1400" title="Fooedx Contact Form"]'); ?> -->
                            <form action="mail.php" method="get" id="footerForm">
                                <div class="customerForm priceLeft boxs">
                                    <h2>Let's take your Food Business to the next level</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input id="phone" type="tel" class="form-control"  name="number" placeholder="Contact Number" required />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="skypid" placeholder="Skype ID">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="msg" placeholder="Brief about the Project">
                                            </div>
                                        </div>
                                        <!-- <div class="capta"> -->
                                            <div class="col-md-12 form-group">
                                                <div class=" recaptcha" id="g-recaptcha1"></div>
                                                <div id="g-recaptcha-errorfooter"></div>
                                            </div>
                                            <div class="col-md-12">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
            <div class="customerRight boxs">
              <!--<form action="mail.php" method="get" id="modalForm">-->
                    <div class="customerForm priceLeft boxs">
                        <h2>Let's take your Food Business to the next level</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input id="phone2" type="tel" class="form-control" name="number" placeholder="Contact Number" required />
                                </div>
                            </div>
                            <div class="col-md-12">
                               <div class="form-group">
                                  <input type="text" class="form-control" name="skypid" placeholder="Skype ID (if available)">
                               </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="msg" placeholder="Brief about your business">
                                </div>
                            </div>
                            <div class="col-md-12 form-group">
                                <div class="recaptcha" id="g-recaptcha1"></div>
                        ...
                        <!-- <?php // echo do_shortcode("[contact-form-7 id='7' title='modal Contact form']"); ?> -->
