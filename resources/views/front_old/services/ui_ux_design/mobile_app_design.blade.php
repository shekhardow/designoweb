                    ...
                    <div class="col-sm-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <span class="bannerHeading boxs">
                                <h1 class="fontSize52">Mobile App Design</h1>
                            </span>
                        ...
                        <div class="mainBannerRight serviceBannerRight boxs">
                            <div class="serviceBannerContent boxs">
                                <span class="serviceMainContent boxs">
                                    <h2 class="servBannerHeading fontSize32 boxs">We make serious versatile applications for different modern spaces.</h2>
                                    <p class="servBannerContent fontSize18 boxs">Our mobile application engineers pursue market directions to ideate, develop, and make versatile applications which adds commitment and advancement to applications.</p>
                                </span>
