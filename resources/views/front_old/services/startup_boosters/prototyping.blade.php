                    ...
                    <div class="col-sm-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <span class="bannerHeading boxs">
                                <h1 class="fontSize52">Prototyping</h1>
                            </span>
                    ...
                    <div class="col-sm-7">
                        <div class="appProcessSection boxs">
                            ...
                            <div class="serviceFor serviceFor2 boxs">
                                <div class="serviceForLists boxs">
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Fast Throwaway Prototype</h4>
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Transformative Prototyping</h4>
                                ...
                                <div class="serviceForLists boxs">
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Steady Prototyping</h4>
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Outrageous Prototyping</h4>
