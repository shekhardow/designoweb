                    ...
                    <div class="col-sm-7">
                        <div class="appProcessSection boxs">
                            ...
                            <div class="serviceFor serviceFor2 boxs">
                                <div class="serviceForLists boxs">
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Strategy Development</h4>
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Campaign Planning</h4>
                                ...
                                <div class="serviceForLists boxs">
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Campaign Execution</h4>
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Campaign Monitoring</h4>
