...
<div class="mainBody boxs">
    ...
    <div class="mopStudyBigImgSec boxs">
        <img src="<?php echo !empty($case_study_detail->case_detail_screen_banner) ? url('uploads/admin/case_studies/' . $case_study_detail->case_detail_screen_banner) : ''; ?>" width="100%" />
    </div>
            ...
            <div class="weDeliverInner boxs">
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        <span class="sectionHeading mainSecHeading mainSecHeading3 mainSecHeading6 boxs">
                        ...
                        <div class="col col-12 col-sm-12 col-md-6">
                            <div class="productsBox boxs">
                                <div class="clientProductImage boxs">
                                    <span class="boxs"><a class="boxs" href="<?php echo url('case_study_details/'.encryptionID($value->case_study_id)); ?>"><img src="<?php echo !empty($value->case_detail_card_image) ? url('uploads/admin/case_studies/' . $value->case_detail_card_image) : ''; ?>" class="img-fluid" alt="Case Image" /></a></span>
                                </div>
                ...
                <div class="row">
                    <div class="col col-12 col-md-7">
                        <div class="reqTeamTxtCont p80sec">
                            ...
                            <p class="fontSize24">Appinventiv provides a dedicated team to brands worldwide to create products that your customers will love.</p>
                            <div class="reqTeamBtnCont">
                                <a href="<?php echo url('contact'); ?>" class="btnStyle btnStyle2 btnBlue">Book A Session<span class="arrowIcn"><i class="fas fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col col-12 col-md-5">
                        <div class="reqTeamImgCont">
                            <img src="<?php echo url('public/front/img/case-study.svg'); ?>" />
                        </div>
                    </div>
                </div>
            </div>
