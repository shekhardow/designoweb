                            ...
                            <div class="quoteAuthorCont2 quoteAuthorCont3 boxs">
                                <div class="quoteAuthorCont ">
                                    ...
                                    <div class="quoteAuthorInfo quoteAuthorInfo2">
                                        ...
                                        <p class="quoteAuthorCountry readTime fontSize16 boxs"><?php echo !empty($blog_detail->created_at) ? date('M d, Y',strtotime($blog_detail->created_at)) : ''; ?></p>
                                    </div>
                                </div>
    ...
    <div class="pressContentDetail blogContentDetail boxs">
        <div class="container">
            <div class="pressContentSec blogContentSec customEditor boxs">
                <span class="boxs customEditor"><?php echo !empty($blog_detail->blog_description) ? $blog_detail->blog_description : ''; ?></span>
            </div>
        </div>
    </div>
