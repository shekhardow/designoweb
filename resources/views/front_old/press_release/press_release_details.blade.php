                ...
                <div class="row">
                    <div class="col-sm-12 col-md-10 col-lg-10 col-xl-7">
                        <div class="mainBannerLeft boxs">
                            ...
                            <span class="bannerHeading bannerHeading4 boxs">
                            ...
                            <div class="quoteAuthorCont2 boxs">
                                <div class="quoteAuthorCont ">
                                    ...
                                    <div class="quoteAuthorInfo">
                                        ...
                                        <p class="quoteAuthorCountry readTime fontSize16 boxs"><?php echo !empty($press_release_detail->created_at) ? date('M d, Y',strtotime($press_release_detail->created_at)) : ''; ?></p>
                                    </div>
                                </div>
                            ...
                            <div class="pressReleaseBox boxs">
                                <div class="pressReleaseImage boxs">
                                    ...
                                    <span class="pressDateTime">
                                        <span class="pressReleaseDate"><?php echo !empty($press_release_detail->created_at) ? date('M d, Y',strtotime($press_release_detail->created_at)) : ''; ?></span>
                                        <!-- <span class="pressReleaseTime">20 mins ago</span> -->
                                    </span>
                                </div>
                                <div class="pressContentBox boxs">
                                    <h3 class="fontSize28 pressBoxHeading boxs"><a href="<?php echo url('press_release_details/'.encryptionID($value->press_release_id)); ?>" class="boxs">Techreviewer Ranks Appinventiv Number 1 Mobile App Developm...</a></h3>
                                    ...
                                    <span class="readMore"><a class="fontSize18 readMoreLink" href="<?php echo url('press_release_details/'.encryptionID($value->press_release_id)); ?>">READ MORE</a></span>
                                </div>
                            </div>
                        </div>
                    <?php }}} ?>
