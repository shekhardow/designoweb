                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <span class="bannerHeading boxs">
                                <h1 class="fontSize52">Hire UI-UX Designers</h1>
                            </span>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Searching for a specialist to get the intelligent and engaging design.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Employ an accomplished UI UX designer for your web and mobile applications project.
                            </p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <span class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why Hire UI/UX Designers From Us ?</h2>
                        </span>
                        <span class="subHeading boxs">
                            <p class="regularFont fontSize18">Make your dream come to reality by working with the experienced designers of Designoweb.</p>
                        </span>
                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Client Testing</h3>
                                        <p class="fontSize18 boxs">Employ devoted UI/UX originators at Designoweb as we direct client testing meetings to gather important input experiences on UI/UX.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Cross-Platform Compatibility</h3>
                                        <p class="fontSize18 boxs">You can employ UI/UX originators from us to keep guideline standards of UI/UX plan to convey stage reliant and responsive plan.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Web Composition Services</h3>
                                        <p class="fontSize18 boxs">We predominantly underline on intelligent web architecture arrangements that lead to your business development. Employ UI UX specialists for administration custom fitted to your business needs.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">IA And Wireframes</h3>
                                        <p class="fontSize18 boxs"> making wireframes to conceptualize and imagine information structure which addresses UI examples and elements on beginning testing of work by our team of Designoweb.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Hand Craft Solutions</h3>
                                        <p class="fontSize18 boxs">We alter your item configuration as per your necessities utilizing progressed instruments and advancements. Therefore it is best for your undertaking to enlist UI/UX fashioners with us.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Data Architecture Supportive UI</h3>
                                        <p class="fontSize18 boxs">Employ UI planners and architects to add settings to the regular conduct of clients to make a strong effect on the main interest groups.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
