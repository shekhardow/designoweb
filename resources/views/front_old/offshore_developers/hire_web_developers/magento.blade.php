                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <span class="bannerHeading boxs">
                                <h1 class="fontSize52">Hire Magento Developers</h1>
                            </span>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Employ our accomplished Magento engineer.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Our Magento engineers incorporate a blend of ensured Magento designers and specialists. We are a team of developers who will make your dream come to reality.
                            </p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <span class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why Hire Magento Developers From Us?</h2>
                        </span>
                        <span class="subHeading boxs">
                            <p class="regularFont fontSize18">Our group of confirmed and master Magento designers have great experience and can make quick and secure internet based stores for organizations, all things considered.</p>
                        </span>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Progressing Maintenance And Management</h3>
                                        <p class="fontSize18 boxs">Enlist our Magento specialists to help with continuous upkeep and the board while you center around your center business.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Magento Theme Development</h3>
                                        <p class="fontSize18 boxs">Employ Magento designers or seaward Magento developers to construct astonishing and intuitive subjects for little to enormous scope organizations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Magento Extension Development</h3>
                                        <p class="fontSize18 boxs">Enlist Magento engineers who are skilled at building tweaked Magento augmentations for your eCommerce online interfaces.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Custom Magento Ecommerce Development</h3>
                                        <p class="fontSize18 boxs">We use the elements and modules of Magento, we make powerful eCommerce stores for organizations We likewise take up fragmented activities and upgrade them with search and easy to understand credits.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Magento 1 To Magento 2 Migration</h3>
                                        <p class="fontSize18 boxs">Secure movement is the need of everybody in the eCommerce business. Our group of engineers is able to move any eCommerce store from Magento 1 to Magento 2 and guarantee its wellbeing, security, and powerful
                                            strength.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Magento Third-Party Integration</h3>
                                        <p class="fontSize18 boxs">Magento offers incorporation like installment, web-based media, delivering, and multi-seller entryways.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
