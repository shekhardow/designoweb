                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mainBannerLeft mainBannerLeft2 boxs">
                            ...
                            <span class="bannerHeading bannerHeading2 boxs">
                    ...
                    <div class="col-sm-6">
                        <div class="mainBannerRight contactBannerRight boxs">
                            <img src="<?php echo url('public/front/img/contact-banner2.png'); ?>" class="img-fluid" alt="Banner Image" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="contactFormInner queryInnerBox boxs">
                ...
                <div class="contactMainForm contactFormsSec boxs">
                    <div class="formMainHeading boxs">
                        <h3 class="fontSize38">Fill this form to get a <span class="highlightFont">FREE</span> consultation:</h3>
                    </div>
                        ...
                        <form id="common-form" action="<?php echo route('front/send_contact_mail'); ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group boxs">
                                        <label>Budget</label>
                                        <select class="form-control" aria-placeholder="Budget" name="budget" id="budget">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group boxs">
                                        ...
                                        <textarea rows="4" placeholder="Comments" name="comments" id="comments" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group boxs">
