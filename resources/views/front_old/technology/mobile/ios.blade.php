                ...
                <div class="row">
                    <div class="col col-12 col-md-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <span class="bannerHeading boxs">
                                <h1 class="fontSize52 blackFont">iOS App Development Company</h1>
                            </span>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Make your dream ios applications come to reality.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Our aptitude in iOS application plan and advancement traverses the whole Apple biological system.
                            </p>
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/img/technologies/ios.png'); ?>" alt="iOS App Development" class="techBannerImg" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Cross Breed iOS App Development</h3>
                                        <p class="fontSize18 boxs">Engineers at Designoweb utilize systems like Flutter, React Native, and so on to grow completely utilitarian applications.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Local iOS App Development</h3>
                                        <p class="fontSize18 boxs"> The group of Designoweb can make very good quality stage explicit applications. We make local portable applications for iOS that are intelligent, instinctive, and easy to use. Your application will have a reliable
                                            look across changed iOS gadgets.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Custom iOS App Development</h3>
                                        <p class="fontSize18 boxs">You can share your application thought and we will transform it into a solid, adaptable, and powerful iOS application. Having ability in shifted iOS advancements, our engineers create custom tailored applications
                                            for fluctuated business verticals.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="benefitsInner flexBox boxs">
                    ...
                    <div class="benefitsRight boxs">
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Adaptable Engagement Model</span>
                            <p class="benefitsListContent fontSize18 boxs">Hire for full-time, low maintenance, fixed-cost, or designer constantly.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Reliable Quality</span>
                            <p class="benefitsListContent fontSize18 boxs">Our cycles are ISO affirmed and we keep up with quality norms.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">On Top of Technologies</span>
                            <p class="benefitsListContent fontSize18 boxs">We are notified about the most recent advancements and patterns in the business.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">100 percent Satisfaction</span>
                            <p class="benefitsListContent fontSize18 boxs">We give 100 percent ensured fulfillment to our clients.</p>
                        </div>
                    </div>
                </div>
            </div>
