                ...
                <div class="row">
                    <div class="col col-12 col-md-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <span class="bannerHeading boxs">
                                <h1 class="fontSize52 blackFont">iOT App Development Company</h1>
                            </span>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Assist with collecting information from actual articles and keenly use it.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                We drive esteem focused IoT arrangements and set up staggered information pipelines for that: from edge figuring to cloud information handling and information science.
                            </p>
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/img/technologies/iot.png'); ?>" alt="iOS App Development" class="techBannerImg" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="benefitsInner flexBox boxs">
                    ...
                    <div class="benefitsRight boxs">
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Accumulate Data</span>
                            <p class="benefitsListContent fontSize18 boxs">We then, impact this climate of related devices to assemble data associated with the business-essential cycles.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">IoT Security</span>
                            <p class="benefitsListContent fontSize18 boxs">We appreciate the significance of wellbeing of the related devices and applications and build it as a piece of the IoT climate.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Interface Devices</span>
                            <p class="benefitsListContent fontSize18 boxs">We send IoT-controlled devices or sensors to create a related organic arrangement of shrewd genuine assets for the business.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Experience Results</span>
                            <p class="benefitsListContent fontSize18 boxs">We help associations by including these pieces of information for settling on valuable decisions that yield higher effectiveness and better client experiences.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="serviceFor boxs">
                                <div class="serviceForLists boxs">
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Necessity Analysis</h4>
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h4 class="fontSize22 boxs">- Wireframing And Designing</h4>
