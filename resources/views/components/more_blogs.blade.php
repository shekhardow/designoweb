    ...
    <div class="blogListBox blogListBoxNew boxs">
        <div class="blogContentTop boxs">
            <div class="blogImage boxs">
                <span class="boxs"><a class="boxs" href="<?php echo route('front/blog_details',['slug' => $blog->slug]); ?>"><img src="<?php echo !empty($blog->image_url) ? url('uploads/admin/blogs/' . $blog->image_url) : ''; ?>" class="img-fluid" alt="Blog Image" /></a></span>
            </div>
