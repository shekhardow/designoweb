                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control" id="order_by" 
                                    data-url="<?php echo url('admin/updateCaseStudyOrder'); ?>" data-case_study_id="<?php echo !empty($value->case_study_id) ? $value->case_study_id : ""; ?>" 
                                    value="<?php echo !empty($value->order_by) ? $value->order_by : ""; ?>">
                                </td>
                                <?php
