                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="m-form__group row">
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="date" class="form-control" id="added_date" name="added_date" value="<?php echo !empty($press_release_detail->added_date) ? date('Y-m-d',strtotime($press_release_detail->added_date)) : NULL ?>">
                                    </div>
                                </div>
                            </div>
