                    ...
                    <div class="col-sm-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">UI-UX Design Services</h1>
                            </div>
                        ...
                        <div class="mainBannerRight serviceBannerRight boxs">
                            <div class="serviceBannerContent boxs">
                                <div class="serviceMainContent boxs">
                                    <h2 class="servBannerHeading fontSize32 boxs">We comprehend the significance of a good plan in computerized achievement. </h2>
                                    <p class="servBannerContent fontSize18 boxs">We offer exhaustive UI/UX administrations that incorporate marking, responsive website composition, portable application plan, client experience counseling, and special plans utilizing the most recent apparatuses and advancements.</p>
                                </div>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Providing Different Types Of UX/UI Design Services</h2>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Configuration Thinking Consultants</h3>
                                        <p class="fontSize18 boxs">Collaborating with driving brands, our plan thinking experts assist clients with comprehension, ideate, approve, assemble and work expertly planned, inventive, client driven and drawing in computerized encounters.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">(UI) Design Services</h3>
                                        <p class="fontSize18 boxs">User-centered, client driven making encounters that convey substantial business results, as a main UI and experience plan organization we assist brands with exploring all possible aspects of the present, and tomorrow's, computerized scene.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        ...
                                        <p class="fontSize18 boxs">We assist endeavors with exploring all possible aspects of the computerized scene, helping with wire-outlining and intuitive prototyping, making encounters that convey substantial business results.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Versatile First Responsive Design Services</h3>
                                        <p class="fontSize18 boxs">Customer-centered, making dynamic responsively planned encounters that convey substantial business results, our group assists brands with exploring all possible aspects of the computerized scene.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Client Experience (CX) Consulting</h3>
                                        <p class="fontSize18 boxs">Customer-centered, making vital advanced arrangements that convey substantial business results, Designoweb's client experience experts assist brands with exploring all possible features of the computerized scene.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Programming Redesign</h3>
                                        <p class="fontSize18 boxs">If you as of now have an application or a site however it doesn't look engaging or proficient, we can help you by re-planning the whole site or application. Subsequent to assessing your application and understanding the clients, we make your product look connected with and wonderful.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="benefitsInner flexBox boxs">
                    ...
                    <div class="benefitsRight boxs">
                        <div class="benefitsLists boxs">
                            ...
                            <p class="benefitsListContent fontSize18 boxs">Avoid the danger of coding flawed client streams and unnecessary highlights by approving thoughts and expected arrangements with little venture of time and cash in UX administrations.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Client Agreeable</span>
                            <p class="benefitsListContent fontSize18 boxs">Meet client needs with widely inclusive and human-focused UI configuration administrations, client experience administrations, and configuration research.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Dependable</span>
                            <p class="benefitsListContent fontSize18 boxs">Reach your interest group with a proficient consumer loyalty, unwaveringly, and maintenance procedure in light of our client centered UX configuration research.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Chivalrous Group</span>
                            <p class="benefitsListContent fontSize18 boxs">Increase future item reception by applying UI/UX administrations to plan items and administrations that are fit to client's necessities and inclinations.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Increase Ease Of Use</span>
                            <p class="benefitsListContent fontSize18 boxs">Boost client securing and standards for dependability by creating fit-for-reason plans with our UI/UX configuration administrations.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Under The Spending Plan</span>
                            <p class="benefitsListContent fontSize18 boxs">Keep to rollout time spans and limit the opportunity of a spending plan overwhelm with the assistance of a period and spending plan agreeable methodology supported by our UX administrations.</p>
                        </div>
                    </div>
                </div>
            </div>
