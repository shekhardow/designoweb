                    ...
                    <div class="col-sm-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Product Development Services</h1>
                            </div>
                    ...
                    <div class="col-sm-7">
                        <div class="appProcessSection boxs">
                            ...
                            <div class="serviceFor serviceFor2 boxs">
                                <div class="serviceForLists boxs">
                                    <div class="serviceForBox boxs">
                                        <h3 class="fontSize22 boxs">- Lean Product Management</h3>
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h3 class="fontSize22 boxs">- Test Driven Development</h3>
                                ...
                                <div class="serviceForLists boxs">
                                    <div class="serviceForBox boxs">
                                        <h3 class="fontSize22 boxs">- DevSecOps Compliant</h3>
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h3 class="fontSize22 boxs">- Site Reliability Engineering</h3>
