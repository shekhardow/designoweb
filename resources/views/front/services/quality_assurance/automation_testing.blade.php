                    ...
                    <div class="col-sm-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Automation Testing Services</h1>
                            </div>
                            <div class="serviceFor serviceFor4 boxs">
                                <div class="serviceForLists boxs">
                                    ...
                                    <div class="serviceForBox boxs">
                                        <h2 class="serviceForBoxChild fontSize18 boldFont boxs">Criticism Framework</h2>
                        ...
                        <div class="mainBannerRight serviceBannerRight boxs">
                            <div class="serviceBannerContent boxs">
                                <div class="serviceMainContent boxs">
                                    <h2 class="servBannerHeading fontSize32 boxs">Designoweb Technologies is well ensures that offer a browsers.</h2>
                                    <p class="servBannerContent fontSize18 boxs">Designoweb Technologies ensures to deliver custom website design services, globally! websites that offer a consistent look and use across different web browsers. Designoweb Technologies ensures to deliver custom website design services, globally! websites that offer a consistent look and use across different web browsers Designoweb Technologies ensures to deliver custom website design Designoweb Technologies ensures to deliver custom website design services, globally.</p>
                                </div>
