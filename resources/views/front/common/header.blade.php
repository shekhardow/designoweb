...
<head>
    ...
    <?php if(@$title == "FoodX"){ ?>
        ...
        <link rel="stylesheet" href="<?php echo url('public/front/css/foodx/style.css?v:18.5'); ?>" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/foodx/media.css?v:18.5'); ?>" />
        ...
        <link href="<?php echo url('public/front/css/style.css?v:16.5'); ?>" rel="stylesheet" />
        <link href="<?php echo url('public/front/css/media.css?v:16.0'); ?>" rel="stylesheet" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" integrity="sha512-3pIirOrwegjM6erE5gPSwkUzO+3cTjpnV9lexlNZqvupR64iZBnOOTiiLPb9M36zpMScbmUNIcHUqKD47M719g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/global.css?v:6.3'); ?>" />
        
    <?php }elseif(@$title == "GrocerX"){ ?>

        <link rel="icon" href="<?php echo url('public/front/img/grocerx/fav.png'); ?>" type="icon/image" />
    	<link rel="stylesheet" href="<?php echo url('public/front/css/common/bootstrap.min.css'); ?>" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.css" />
    	<link rel="stylesheet" href="<?php echo url('public/front/css/common/hamburgers.css'); ?>" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/common/intlTelInput.min.css'); ?>" />
    	<link rel="stylesheet" href="<?php echo url('public/front/css/common/slick-theme.css'); ?>" />
    	<link rel="stylesheet" href="<?php echo url('public/front/css/common/slick.css'); ?>" />
    	<link rel="stylesheet" href="<?php echo url('public/front/css/grocerx/style.css?v:18.1'); ?>" />
    	<link rel="stylesheet" href="<?php echo url('public/front/css/grocerx/media.css?v:18.1'); ?>" />
        ...
        <link href="<?php echo url('public/front/css/intlTelInput.min.css'); ?>" rel="stylesheet" />
        <link href="<?php echo url('public/front/css/style.css?v:16.5'); ?>" rel="stylesheet" />
        <link href="<?php echo url('public/front/css/media.css?v:16.1'); ?>" rel="stylesheet" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" integrity="sha512-3pIirOrwegjM6erE5gPSwkUzO+3cTjpnV9lexlNZqvupR64iZBnOOTiiLPb9M36zpMScbmUNIcHUqKD47M719g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/global.css?v:18.1'); ?>" />
    ...
    <?php }elseif(@$title == "MedX"){ ?>
        ...
        <link rel="stylesheet" href="<?php echo url('public/front/css/common/slick-theme.css'); ?>" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/common/slick.css'); ?>" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/medx/style.css?v:23.5'); ?>" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/medx/media.css?v:24.8'); ?>" />
        ...
        <link href="<?php echo url('public/front/css/media.css?v:16.0'); ?>" rel="stylesheet" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" integrity="sha512-3pIirOrwegjM6erE5gPSwkUzO+3cTjpnV9lexlNZqvupR64iZBnOOTiiLPb9M36zpMScbmUNIcHUqKD47M719g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        <link rel="stylesheet" href="<?php echo url('public/front/css/global.css?v:6.4'); ?>" />
    ...
    <?php }else{ ?>
        ...
        <link href="<?php echo url('public/front/css/slick-theme.css'); ?>" rel="stylesheet" />
        <link href="<?php echo url('public/front/css/intlTelInput.min.css'); ?>" rel="stylesheet" />
        <link href="<?php echo url('public/front/css/style.css?v:17.5'); ?>" rel="stylesheet" />
        <link href="<?php echo url('public/front/css/media.css?v:16.3'); ?>" rel="stylesheet" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" integrity="sha512-3pIirOrwegjM6erE5gPSwkUzO+3cTjpnV9lexlNZqvupR64iZBnOOTiiLPb9M36zpMScbmUNIcHUqKD47M719g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
                                                                         ...
                                                                         <div class="col-sm-12 col-md-4">
                                                                            <div class="newMenuListItem boxs subMenuHeadings subMenuListsSec subMenuListsSecNew">
                                                                                <div class="boxs">
                                                                                    ...
                                                                                    <div class="newMenuItemDescription neWMenuItemList boxs subMenuHeadings"><p>The World’s Best AI Based Food Delivery Solution for your Business.</p></div>
                                                                                </div>
                                                                                <span class="newMenuItemBanner neWMenuItemList boxs">
                                                                                    <img src="<?php echo asset('/public/front/img/images/foodxMenu.webp'); ?>" alt="Product Banner" class="img-fluid"/>
                                                                                </span>
                                                                            </div>
                                                                         </div>
                                                                         <div class="col-sm-12 col-md-4">
                                                                            <div class="newMenuListItem boxs subMenuHeadings subMenuListsSec subMenuListsSecNew">
                                                                                <div class="boxs">
                                                                                    ...
                                                                                    <div class="newMenuItemDescription neWMenuItemList boxs subMenuHeadings"><p>The World’s Best AI-Based Grocery Delivery Solution for your Business.</p></div>
                                                                                </div>
                                                                                <span class="newMenuItemBanner neWMenuItemList boxs">
                                                                                    <img src="<?php echo asset('/public/front/img/images/grocerxMenu.webp'); ?>" alt="Product Banner" class="img-fluid"/>
                                                                                </span>
                                                                            </div>
                                                                         </div>
                                                                         <div class="col-sm-12 col-md-4">
                                                                            <div class="newMenuListItem boxs subMenuHeadings subMenuListsSec subMenuListsSecNew">
                                                                                ...
                                                                                <span class="newMenuItemBanner neWMenuItemList boxs">
                                                                                    <img src="<?php echo asset('/public/front/img/images/medxMenu.webp'); ?>" alt="Product Banner" class="img-fluid"/>
                                                                                </span>
                                                                            </div>
                                                                         </div>
                                                                    </div>
