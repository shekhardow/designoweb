                ...
                <div class="row">
                    <div class="col col-12 col-md-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52 blackFont">Docker App Development</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Construct, test, and send applications rapidly.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Docker Business assists associations with building current applications at scale without compromising security and consistency.
                            </p>
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/images/technologies/docker.webp'); ?>" alt="Technology Banner" class="techBannerImg" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Systems</h3>
                                        <p class="fontSize18 boxs">The cloud procedure and counseling administrations at Designoweb go about as a solid help for the ventures to comprehend and use the different benefits of cloud innovation.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Relocation</h3>
                                        <p class="fontSize18 boxs"> The movement administrations help smooth the progress of your information in the midst of various conditions in light of your prerequisite, keeping protection standards, information honesty, business congruence,
                                            and security as a main priority.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        ...
                                        <p class="fontSize18 boxs">Regular help and upkeep is expected to keep the Project secure from framework disappointments and forestall efficiency issues. Legitimate upkeep guarantees compelling execution and every one of the applications
                                            made accessible through it.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="benefitsBox boxs">
                <div class="benefitsInner flexBox boxs">
                    <div class="benefitsLeft flexBox boxs">
                        <span class="benefitsLeftImg"><img src="<?php echo url('public/front/images/docker-img1.webp'); ?>" class="img-fluid" alt="Benefits Banner"></span>
                    </div>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs mb-0">
                            <h2 class="fontSize48 boxs pb-0">Why To Choose Us As Your Docker Development Company?</h2>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col col-12 col-lg-5">
                        <div class="appProcessBanner boxs h-100 d-flex align-items-center ourProcessRight">
                            <img src="<?php echo url('public/front/images/docker-img1.webp'); ?>" class="img-fluid" alt="Banner Image" />
                        </div>
                    </div>
                </div>
            </div>
