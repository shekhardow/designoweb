                ...
                <div class="row">
                    <div class="col col-12 col-md-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52 blackFont">Wordpress Development</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Web advancement organization cutting computerized arrangements.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                WordPress designers who have great involvement with building WordPress applications. We have a group of representatives that deals with requests to offer productive and hearty administrations.
                            </p>
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/images/technologies/wordpress.webp'); ?>" alt="Technology Banner" class="techBannerImg" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Installment Solution</h3>
                                        <p class="fontSize18 boxs">We are specialists in guaranteeing the consistent value-based insight for the clients all around the world and We additionally execute tough safety efforts.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Online Business Solutions</h3>
                                        <p class="fontSize18 boxs">We additionally coordinate fundamental modules and highlights to assemble a completely utilitarian eCommerce site that will give a powerful web-based presence universally.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        ...
                                        <p class="fontSize18 boxs">The substance creation process is less complex and faster to keep your webpage refreshed constantly by utilizing the highlights of CMS. We make a site which is not difficult to make due.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs mb-0">
                            <h2 class="fontSize48 boxs pb-0">Why To Choose Us As Your Wordpress Development Company?</h2>
                        </div>
