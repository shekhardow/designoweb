                ...
                <div class="row">
                    <div class="col col-12 col-md-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52 blackFont">Php App Development</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Web advancement answers for our clients.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                We have dominated in an eminent ability in creating dynamic, superior execution, and information base driven PHP arrangements.
                            </p>
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/images/technologies/php.webp'); ?>" alt="Technology Banner" class="techBannerImg" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        ...
                                        <p class="fontSize18 boxs">We incorporate outsider APIs into your PHP sites according to your necessities and prerequisites utilizing different connection points given.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Person To Person Communication Solutions</h3>
                                        <p class="fontSize18 boxs">The group at Designoweb uses the most recent patterns of the PHP successfully to grow profoundly captivating, appealing, and cooperative interpersonal interaction sites.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Online Business PHP Solutions</h3>
                                        <p class="fontSize18 boxs"> To construct top notch eCommerce arrangements that bear current highlights and functionalities ,We have the right stuff and abilities to make exceptionally modified eCommerce entrances.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs mb-0">
                            <h2 class="fontSize48 boxs pb-0">Why To Choose Us As Your PHP App Development Company?</h2>
                        </div>
