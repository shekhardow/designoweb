                ...
                <div class="row">
                    <div class="col col-12 col-md-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52 blackFont">Ruby App Development</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Get elite, full focus on your custom web application projects.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Building secure and adaptable applications and furthermore assist you with saving your improvement time and cost.
                            </p>
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/images/technologies/ruby-on-rails.webp'); ?>" alt="Technology Banner" class="techBannerImg" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Entrance Development</h3>
                                        <p class="fontSize18 boxs">Our group is knowledgeable in making highlight rich and progressed web-based interfaces for new businesses and ventures. They are likewise capable of growing profoundly useful, productive, and easy to use online
                                            interfaces for new companies and beginning phase organizations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Porting And Migration</h3>
                                        <p class="fontSize18 boxs">Service: Relocating your ROR framework or application can be careful. We have encountered experts who assist you with moving ROR applications to different CMS, structure, or framework.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Long Range Informal Communication Development</h3>
                                        <p class="fontSize18 boxs">We create and convey the most dependable informal communication arrangements, group cooperation, discussions, and other web applications that work with individuals to individuals association.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs mb-0">
                            <h2 class="fontSize48 boxs pb-0">Why To Choose Us As Your Ruby App Development Company?</h2>
                        </div>
