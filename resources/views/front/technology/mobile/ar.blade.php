                ...
                <div class="row">
                    <div class="col col-12 col-md-6">
                        <div class="mainBannerLeft serviceBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52 blackFont">Augmented Reality Development</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Compelling Augmented Reality App advancement administrations.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Expanding their memorability with our amazing AR application advancement.
                            </p>
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/images/technologies/ar.webp'); ?>" alt="Technology Banner" class="techBannerImg" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Area Based AR</h3>
                                        <p class="fontSize18 boxs">Advancement that would utilize a portion of your gadget highlights, for example, GPS and compass to determine client area. This is a high level element that would improve the client experience by following and
                                            focusing on.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">AR Mobile App Development</h3>
                                        <p class="fontSize18 boxs">Developers at Designoweb will foster versatile and secure Ar applications for android and iOS with the most recent OS compatibility imbued and they will make an application that would offer one of a kind, intelligent
                                            and appealing plans.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">AR Integration To eCommerce</h3>
                                        <p class="fontSize18 boxs">The group of Designoweb Ar application engineers will change your eCommerce business while upgrading the shopping experience for your clients.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="benefitsInner flexBox boxs">
                    ...
                    <div class="benefitsRight boxs">
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Customization</span>
                            <p class="benefitsListContent fontSize18 boxs">We will make precisely the way that you expect your Augmented Reality App Development ought to be with ideal customization accessible.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Upkeep</span>
                            <p class="benefitsListContent fontSize18 boxs">We will deal with your AR application while keeping it kept up with the most recent innovation and highlights.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Hearty Solutions</span>
                            <p class="benefitsListContent fontSize18 boxs">We guarantee you to offer outright overhauled innovation with high-performing vigorous AR applications.</p>
                        </div>
                        <div class="benefitsLists boxs">
                            <span class="benefitsListHeading fontSize24 boxs">Client Experience</span>
                            <p class="benefitsListContent fontSize18 boxs">We will make AR applications that will enjoy the benefit of being easy to use effortlessly.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs mb-0">
                            <h2 class="fontSize48 boxs pb-0">Why To Choose Us As Your Augmented Reality Development Company?</h2>
                        </div>
