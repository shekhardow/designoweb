...
<div class="mainBody sectionTop boxs">
    ...
    <div class="oneTeamSection boxs oneTeamSectionNew">
        <div class="container">
                                    ...
                                    <div class="ourSolutionBox ourSolutionBox2 appDevelopment boxs">
                                        <div class="solutionBoxBanner boxs">
                                            <a href="<?php echo route('front/services_mobile_app_development'); ?>" class="boxs">
                                                <h3 class="fontSize28 boxs"><span>Mobile App <br>Development</span></h3>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="ourSolutionBox webDesign boxs">
                                    ...
                                    <div class="solutionBoxContnet boxs">
                                        <ul class="stepsList boxs">
                                            <li class="stepsListItem">
                                                <span class="fontSize18"><a href="<?php echo route('front/services_product_design'); ?>">Product Design</a></span>
                                            </li>
                                            <li class="stepsListItem">
                            ...
                            <div class="col-sm-12">
                                <div class="growthHacking boxs">
                                    <div class="growthHackImg grwothHackInners boxs">
                                        <img src="<?php echo url('public/front/img/images/growth-banner.webp'); ?>" class="img-fluid" alt="Section Image" loading="lazy" />
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="projectSlideContent boxs">
                                        ...
                                        <div class="projectContentBox boxs">
                                            ...
                                            <div class="viewWebsiteBox viewWebsiteWebBtn boxs">
                                                <span><a href="<?php echo url('case-study-detail/loop'); ?>" class="btnStyle smallBtn">View Case Study<span class="arrowIcn"><i class="fas fa-arrow-right"></i></span></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
