                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="serviceBannerRight boxs">
                            <img src="<?php echo url('public/front/img/testimonials-banner.png'); ?>" alt="Testimonials" class="img-fluid techBannerImg" />
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="aboutSlidesInner flexBox boxs">
                                    <div class="aboutSlideContent boxs">
                                        <span class="aboutQuoteIcon boxs">
                                            <img src="<?php echo url('public/front/img/sliderQuote.png'); ?>" class="img-fluid" alt="Quote Icon" />
                                        </span>
                                        ...
                                        <span class="testimonialVideoBox boxs">
                                            <a class="watchYTVidBtn testimonialVideoLink" data-src="<?php echo !empty($value->video_link) ? $value->video_link : ''; ?>" href="javascript:void(0)" data-bs-target="#testimonialModal" data-bs-toggle="modal"><img src="<?php echo url('public/front/img/youtube.png'); ?>" alt="youtube" />WATCH VIDEO</a>
                                        </span>
                                    </div>
                                    <div class="aboutSlideImage boxs">
                                        <span><img src="<?php echo !empty($value->client_image) ? url('uploads/admin/testimonials/'.$value->client_image) : ''; ?>" class="img-fluid" alt="Slide Image" /></span>
                                    </div>
                                </div>
                            </div>
                        <?php }} ?>
                        ...
                        <?php if(!empty($testimonials)){ foreach($testimonials->skip(2)->take(1) as $value){ ?>
                            <div class="aboutSlides boxs">
                                <div class="aboutSlidesInner flexBox boxs">
                                    <div class="aboutSlideContent boxs">
                                        <span class="aboutQuoteIcon boxs">
                                            <img src="<?php echo url('public/front/img/sliderQuote.png'); ?>" class="img-fluid" alt="QuoteIcon" />
                                        </span>
                                        <span class="aboutQuote fontSize18 boxs"><?php echo !empty($value->client_quote) ? $value->client_quote : ''; ?></span>
                                        <span class="quoteBy fontSize20 boxs"><?php echo !empty($value->client_name) ? $value->client_name : ''; ?></span>
                                        <span class="quoteCountry fontSize18 boxs"><?php echo !empty($value->project_name) ? $value->project_name : ''; ?></span>
