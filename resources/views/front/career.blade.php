                ...
                <div class="row">
                    ...
                    <div class="col col-12 col-lg-6">
                        <div class="serviceBannerRight boxs">
                            <div class="boxs">
                                <img src="<?php echo url('public/front/images/career/career-banner.webp'); ?>" alt="career banner" class="img-fluid" class="img-fluid" loading="lazy" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="imgGrdCol">
                            <div class="row">
                                <div class="col col-12 col-sm-6">
                                    <div class="imgCont">
                                        <img src="<?php echo url('public/front/images/career/career-communication.webp'); ?>" class="img-fluid" alt="career image" loading="lazy" />
                                    </div>
                                </div>
                                <div class="col col-12 col-sm-6">
                                    <div class="txtCont">
                            ...
                            <div class="row">
                                <div class="col col-12 col-sm-6">
                                    <div class="imgCont">
                                        <img src="<?php echo url('public/front/images/career/career-authority.webp'); ?>" class="img-fluid" alt="career image" loading="lazy" />
                                    </div>
                                </div>
                                <div class="col col-12 col-sm-6">
                                    <div class="txtCont">
