...
<div class="mainBody boxs">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="caseMobBanner boxs">
                            <img src="<?php echo !empty($case_study_detail->case_banner) ? url('uploads/admin/case_studies/' . $case_study_detail->case_banner) : ''; ?>" alt="Banner Image" class="img-fluid" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mopStudyBigImgSec boxs">
        <img src="<?php echo !empty($case_study_detail->case_detail_screen_banner) ? url('uploads/admin/case_studies/' . $case_study_detail->case_detail_screen_banner) : ''; ?>" alt="Product Banner" class="img-fluid w-100" loading="lazy" />
    </div>
                ...
                <div class="agileProcStepsCont agileProcStepsCont2">
                    <div class="agileProcStep agileStepOne">
                        ...
                        <div class="processStepsInner boxs">
                            <span class="innerImg boxs"><img src="<?php echo url('public/front/images/agile-step-img.png'); ?>" class="img-fluid" alt="Image" loading="lazy"></span>
                            <span class="innerContent boxs">Concept</span>
                        </div>
                    </div>
                    <div class="agileProcStep agileStepOne">
                        <span class="agileStepCircle"><img src="<?php echo url('public/front/images/agile-proc-2.png'); ?>" alt="agile process step 2" class="img-fluid" loading="lazy"/></span>
                        <div class="processStepsInner boxs">
                            <span class="innerImg boxs"><img src="<?php echo url('public/front/images/agile-step-img2.png'); ?>" class="img-fluid" alt="Image" loading="lazy"></span>
                            <span class="innerContent boxs">Design</span>
                        </div>
                    </div>
                    <div class="agileProcStep agileStepOne">
                        <span class="agileStepCircle"><img src="<?php echo url('public/front/images/agile-proc-3.png'); ?>" alt="agile process step 3" class="img-fluid" loading="lazy"/></span>
                        <div class="processStepsInner boxs">
                            <span class="innerImg boxs"><img src="<?php echo url('public/front/images/agile-step-img3.png'); ?>" class="img-fluid" alt="Image" loading="lazy"></span>
                            <span class="innerContent boxs">Development</span>
                        </div>
                    </div>
                    <div class="agileProcStep agileStepOne">
                        <span class="agileStepCircle"><img src="<?php echo url('public/front/images/agile-proc-4.png'); ?>" alt="agile process step 4" class="img-fluid" loading="lazy" /></span>
                        <div class="processStepsInner boxs">
                            <span class="innerImg boxs"><img src="<?php echo url('public/front/images/agile-step-img4.png'); ?>" class="img-fluid" alt="Image" loading="lazy"></span>
                        ...
                        <div class="aboutSlides customSlides boxs">
                            <div class="aboutSlidesInner flexBox boxs">
                                <div class="aboutSlideContent boxs">
                                    <span class="aboutQuoteIcon boxs"><img src="<?php echo url('public/front/img/sliderQuote.png'); ?>" class="img-fluid" alt="Icon" loading="lazy" /></span>
                                ...
                                <div class="aboutSlideImage boxs">
                                    <span><img src="<?php echo !empty($case_study_detail->client_image) ? url('uploads/admin/case_studies/' . $case_study_detail->client_image) : ''; ?>" class="img-fluid" alt="Slide Image" loading="lazy" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col col-12 col-sm-12 col-md-6">
                            <div class="productsBox boxs">
                                <div class="clientProductImage boxs">
                                    <span class="boxs"><a class="boxs" href="<?php echo route('front/case_study_details',['slug' => $value->slug]); ?>"><img src="<?php echo !empty($value->case_detail_card_image) ? url('uploads/admin/case_studies/' . $value->case_detail_card_image) : ''; ?>" class="img-fluid" alt="Case Image" loading="lazy" /></a></span>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col col-12 col-md-5">
                        <div class="reqTeamImgCont">
                            <img src="<?php echo url('public/front/images/case-study.svg'); ?>" class="img-fluid" alt="Team Presentation" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
