            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="foodLeft boxs">
                        <span class="productWebLogo boxs"><img src="<?php echo url('public/front/img/images/foodxLogo.png'); ?>" class="img-fluid" alt="Product Logo" /></span>
                        <h1 class="world">The <span class="spanColor">World’s Best<span class="greenBar"></span></span> AI Based Food Delivery Solution for your Business.</h1>
                                    ...
                                    <div class="btns btns1 boxs">
                                        <ul class="launchBtn">
                                            <li class="nav-item launchBtnGreen logbtnGreen greenHover" data-toggle="modal" data-target="#myModalApp">
                                                <a class="nav-link" href="<?php echo route('front/contact'); ?>">Get in touch</a>
                                            </li>
        ...
        <div class="foodxAppMain boxs">
            <div class="foodxCenter foodxWorldMain foodxWorldMainLists boxs">
                ...
                <div class="btnsgroups boxs">
                    ...
                    <ul class="nav nav-tabs foodXTab launchBtn boxs foodxWorldMainTabs" id="myTab" role="tablist">
                    ...
                    <div class="dummyRight boxs">
                        <ul>
                            <li class="nav-item launchBtnWhite dummyBtn greenHover logbtnWhite" data-toggle="modal" data-target="#myModalApp">
                                <a class="nav-link" href="<?php echo route('front/contact'); ?>">Contact us </a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="surpriseMain boxs d-flex">
            ...
            <div class="surpriseRight priceLeft ">
                ...
                <div class="surpriseBtn btnfixed launchBtnGreen logbtnGreen greenHover" data-toggle="modal" data-target="#myModalApp">
                    <a class="nav-link" href="<?php echo route('front/contact'); ?>">Buy Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="trustMain boxs">
            ...
            <div class="trustBtn launchBtnGreen logbtnGreen greenHover" data-toggle="modal" data-target="#myModalApp">
                <a class="nav-link" href="<?php echo route('front/contact'); ?>">Book Now</a>
            </div>
        </div>
    </div>
</section>
