            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="foodLeft boxs">
                        <span class="productWebLogo boxs"><img src="<?php echo url('public/front/images/foodxLogo.png'); ?>" class="img-fluid" alt="Product Logo" /></span>
        ...
        <div class="hereWorkMain boxs">
            <div class="row hereRow2">
                ...
                <div class="col-md-6">
                    <div class="workLeft boxs">
                        <div class="perfectLeft foodxWorldMain sectionContent">
                            <h2><img src="<?php echo url('public/front/img/foodx/boom.svg'); ?>" alt="boom" class="img-fluid boom"><span class="colorPrimary">We are Live</span><br> your Restaurant Ready to Deliver Online </h2>
