                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Hire .Net Developers</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Searching for guaranteed remote .NET engineers under budget?
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Our first-time-right seaward .NET engineers construct vigorous, secure, and versatile web applications for worldwide customers at reasonable costs.
                            </p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why Hire .Net Developers From Us?</h2>
                        </div>
                        <div class="subHeading boxs">
                            <p class="regularFont fontSize18">Devoted .Net engineers at Designoweb are exceptionally skilled in creating you a website of your desires.</p>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Devoted .Net Developers</h3>
                                        <p class="fontSize18 boxs">Enhance your advancement abilities with committed improvement groups. Enlist devoted .Net web designers from us who are talented in building solid and utilitarian web applications for worldwide organizations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Elite Performance</h3>
                                        <p class="fontSize18 boxs">Get superior execution applications, including Windows GUI applications, Windows Console applications and Smart Client applications, and so on, created by our .Net software engineers.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">The Board And Maintenance</h3>
                                        <p class="fontSize18 boxs">You can configure, investigate, oversee and keep up with your applications with the assistance of our .Net designers as they are essentially talented around there.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Iot And Embedded Systems</h3>
                                        <p class="fontSize18 boxs">We have software engineers that have significant experience building secure, hearty, much esteemed, and superior execution IoT and implanted frameworks.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Cloud Solutions And Integration</h3>
                                        <p class="fontSize18 boxs">Our designers have fabricated ASP.NET that are worked with a cloud emotionally supportive network which keeps the security, speed and unwavering quality unblemished.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">.Net Migration</h3>
                                        <p class="fontSize18 boxs">You can get your current heritage web applications moved into .Net with the assistance of our master .NET engineers, who can even move your .Net application into some other innovation of your decision.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
