                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">IT Staff Augmentation</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                We offer committed Staff Augmentation for each kind of big business project.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">Our IT staffing administrations assist associations with profiting cutthroat help of actually talented experts having the sharpness to increase your advancement task.</p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why To Hire It Staff Augmentation From Us?</h2>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">24×7 Recruitment Process</h3>
                                        <p class="fontSize18 boxs">Here, we give a nonstop enlistment cycle to clients guaranteeing prompt admittance to the genuinely necessary ability. See as the exhaustive and straightforward IT staff increase enrollment process.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Top IT Talents</h3>
                                        <p class="fontSize18 boxs">We work in giving tailor-made innovation backing of first rate IT ability. We have an inborn computerized administration personality to change each and every industry easily.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Committed Teams</h3>
                                        <p class="fontSize18 boxs">With IT staffing administrations, we allot experts to your specific task. Specialists and engineers are not designated to different activities or records.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Save Time And Effort</h3>
                                        <p class="fontSize18 boxs">Best consent to your undertaking cutoff times by getting on-request IT staff anytime. Here, you can track down the right experts for the ideal decision of a job in your organization.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Keep Up With Oversight</h3>
                                        <p class="fontSize18 boxs">Our master specialists straightforwardly work together with your current in-house group and report straightforwardly, partake in day by day advancement exercises, and normal gatherings.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Aptitude</h3>
                                        <p class="fontSize18 boxs">We thoroughly test for sensible/numerical thinking abilities, specialized capacity and delicate abilities in our screening. Just those engineers who score profoundly across every one of these areas are introduced
                                            to our clients.</p>
                                    </div>
                                </div>
                            </div>
