...
<div class="mainBody sectionTop boxs">
                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Hire Android Developers</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Is it true or not that you are wanting to rethink services for building a local Android application?
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Employ Android application engineers to fabricate progress, include rich, and secure portable applications.
                            </p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why Hire Android Developers From Us?</h2>
                        </div>
                        <div class="subHeading boxs">
                            <p class="regularFont fontSize18">Android application engineers who can assist you with providing well known versatile stage with a cutthroat application.</p>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Wearable App Development</h3>
                                        <p class="fontSize18 boxs">Designoweb’s Android application engineers associate individuals through wearable gadgets like Android wears and Google glasses. We will be launching services to provide people with various unmatched wearable
                                            solutions.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Blockchain Based Apps</h3>
                                        <p class="fontSize18 boxs">Our Android application designers assists the crowd with conveying a protected blockchain application with cutting edge information security, appropriated record, autonomous confirmation, and better straightforwardness.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        ...
                                        <p class="fontSize18 boxs">Our Android Studio designer will effectively port your current application to Android to empower you to offer the application to a more broad client base and expand income age and provide you with more information.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Committed App Developers</h3>
                                        <p class="fontSize18 boxs">Broaden your advancement strength with our committed Android application engineers and construct highlight rich, versatile, and secure Android applications. We will also provide the customization of your application
                                            for a smooth going.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">AI Based Apps</h3>
                                        <p class="fontSize18 boxs">Get an application with AI-based highlights like face acknowledgment, customized list items, chatbots, and so on with the help of our developers. With the assistance of Machine Learning calculations, our Android
                                            application coders construct keen and creative AI-based portable applications for organizations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">AR/VR Android Apps</h3>
                                        <p class="fontSize18 boxs">With our Android application engineers who are specialists in utilizing AR/VR, you can get an intelligent and natural application for the end-clients and take your application to an all-new stature. Our seaward
                                            Android application developers construct intuitive and creative Augmented and Virtual Reality applications for a long time.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="aboutUsSec2 boxs greyBgBox">
        <div class="container">
