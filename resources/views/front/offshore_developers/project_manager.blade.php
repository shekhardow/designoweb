                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Hire Project Manager</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Employing Project Managers to deal with your project can be more straightforward.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                A committed manager can assist your business with leaving on an advanced project inside with a quicker turnaround time and lesser expense.
                            </p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why Hire Project Managers From Us?</h2>
                        </div>
                        <div class="subHeading boxs">
                            <p class="regularFont fontSize18">We make a strong blend of advancement, openness, and commitment to satisfy the future-arranged necessities of every confident business affiliation searching for improvement.</p>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Exchange</h3>
                                        <p class="fontSize18 boxs">Our PM concentrates on your objectives, financial plan, and cutoff times, and suggests the most suitable participation model. This individual takes part in molding your future web improvement group.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Improvement</h3>
                                        <p class="fontSize18 boxs">A Project manager in Designoweb allots assignments, coordinates group gatherings, handles the everyday schedules, tracks the advancement, resolves generally forthcoming issues, eliminates any impediments in
                                            the smooth improvement process, assembles ordinary input from the client, and substantially more.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Further Maintenance</h3>
                                        <p class="fontSize18 boxs">Communication, task distribution, execution control, and considerably more is finished by the PM of the Designoweb group. A venture administrator likewise watches out for the site and informs the client.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Dealing With The Organization Expectations</h3>
                                        <p class="fontSize18 boxs">The task manager obligations incorporate guaranteeing that the expectations that are followed through on schedule and inside spending plan. Our managers strive to make your fantasies come to a reality.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Keeping The Group Affectionate</h3>
                                        <p class="fontSize18 boxs">Apart from building a group that is loaded up with enthusiastic individuals who are independent, our project manager additionally ensures that the group works flawlessly as a solitary unit.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Organizing With The Customers</h3>
                                        <p class="fontSize18 boxs">Designoweb's project manager is capable of having the customers and partners audit basically everything and figure out what requirements change and what needs improvement.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="aboutUsSecInner boxs">
                <div class="mainSecHeading topSectionHead boxs">
                    ...
                    <div class="secHeadingRight"><a href="<?php echo route('front/testimonials'); ?>" class="btnStyle btnStyle3 smallBtn smallBtn2">Read Testimonials<span class="arrowIcn"><i class="fas fa-arrow-right"></i></span></a>
                    </div>
                </div>
