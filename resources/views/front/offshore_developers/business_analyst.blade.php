                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Hire Business Analysts</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Hire committed Business Analysts online from Designoweb.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Employ Business experts assist with working with answers for current or future issues for partners.
                            </p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why Hire Business Analyst From Us?</h2>
                        </div>
                        <div class="subHeading boxs">
                            <p class="regularFont fontSize18">Our Business experts assist with working with answers for current or future issues for partners.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Support the Project Implementation</h3>
                                        <p class="fontSize18 boxs">Our analysts support a critical thinking meeting to distinguish how certain business prerequisites can be met given recently recognized innovation imperatives.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Useful Requirements and Non-Functional Requirements</h3>
                                        <p class="fontSize18 boxs">Analysts figure out how the venture should treat how the task should function in the terms of what the project ought to do and how the task should work.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Specialized Writing, Decision Making and Problem Solving</h3>
                                        <p class="fontSize18 boxs">Working of business prerequisites determination, just as different periods of documentation are completely finished by our specialists. They create educational, intelligent, and usable reports for proficient
                                            achievement.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Upkeep of System and Operations</h3>
                                        <p class="fontSize18 boxs">Experts move to forestall or address defects, making changes, upgrades, and support of the framework to improve the worth of the framework. They are likewise associated with giving upkeep reports, framework
                                            approval reports, deactivation plans.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Group Building</h3>
                                        <p class="fontSize18 boxs">Our examiners lead hoc or formalized groups. They are in coordination, construction, and assist with joining individuals to make their job all the more effective.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Client Acceptance Testing</h3>
                                        <p class="fontSize18 boxs">Guaranteeing that the item is working admirably as it is intended for, as well as guaranteeing the item conveyed fulfills the client necessities is perhaps the most imperative obligations of our analyst.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
