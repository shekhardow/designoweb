                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Hire Dedicated Teams</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Recruiting an independent group that is committed.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                Designoweb assists you with lessening the expenses and accelerates improvement by offering administrations of its devoted advancement groups.
                            </p>
                ...
                <div class="weDeliverContent boxs">
                    <div class="weDeliverTop boxs">
                        ...
                        <div class="sectionHeading mainSecHeading mainSecHeading3 boxs">
                            <h2 class="blackFont fontSize48 pb-0">Why To Hire Dedicated Teams From Us?</h2>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">No Costly Enlistment Process</h3>
                                        <p class="fontSize18 boxs">The expense of employing a committed group is straightforward, as you don't need to stress over eccentric costs on choosing, checking and collecting IT experts in a group - we do that for you.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Benefit From Fast And Simple Increase</h3>
                                        <p class="fontSize18 boxs">The group's arrangement takes brief period as our IT specialists as of now have a common comprehension from effectively cooperating on comparable commitment and can zero in on rapidly coordinating into your
                                            advancement interaction.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">No Changes</h3>
                                        <p class="fontSize18 boxs">We are adaptable to adjust to your current correspondence model and help to tune every one of the required instruments and climate for your group to work together with our group without extra endeavors.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Keep Full Specialized Proprietorship</h3>
                                        <p class="fontSize18 boxs">We share our organization's accepted procedures and pass on all the venture relics and information gathered in the task to your in-house group.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Control The Outcomes Without Investing Energy</h3>
                                        <p class="fontSize18 boxs">We give a devoted venture supervisor who controls the everyday cycle and work processes and reports to your task chief regularly on a case by case basis to guarantee process straightforwardness and arrangement
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Solid Math, Science And Engineering Education</h3>
                                        <p class="fontSize18 boxs">We assemble top tier experts around building strong programming. Joined with proficient administration, it establishes a moving climate.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
