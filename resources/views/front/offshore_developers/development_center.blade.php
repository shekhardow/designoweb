                    ...
                    <div class="col-sm-6">
                        <div class="serviceBannerLeft mainBannerLeft boxs">
                            <div class="bannerHeading boxs">
                                <h1 class="fontSize52">Offshore Development Center</h1>
                            </div>
                            <p class="bannerSubHeading bannerSubHeading2 bannerSubHeading3 fontSize28 boxs">
                                Offshore development habitats giving practical arrangements.
                            </p>
                            <p class="bannerSmallContent fontSize18 boxs">
                                A decent Offshore advancement place gives a practical arrangement, yet in addition assists associations with appointing the errands of recruiting and overseeing assets.
                            </p>
                            ...
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Control And Transparency</h3>
                                        <p class="fontSize18 boxs">Our Offshore Development Center permits you unlimited authority over the undertaking improvement run, financial plan, seaward colleagues, work, and the chance of overseeing it powerfully.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Readiness</h3>
                                        <p class="fontSize18 boxs">Agility is at the center of offshoring, and we comprehend the degree of adaptability required. Our seaward improvement administrations ensure you get a capable and very much overseen group.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Support</h3>
                                        <p class="fontSize18 boxs">We offer unmatched help that is unbound by time and time regions. Our breathtaking help group is prepared all of the time to manage any test 24 hours every day and multi day.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Decreased Cost And Higher ROI</h3>
                                        <p class="fontSize18 boxs">Offshore Development Services offer a huge decrease in immediate and circuitous costs since the associations don't cause costs on foundation advancement, recruiting.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Admittance To Expertise</h3>
                                        <p class="fontSize18 boxs">You have the choice to increase your innovation group, on-request, with different abilities sets. Also, organizations can browse a wide scope of innovation contributions.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="deliverListBox boxs">
                                    ...
                                    <div class="deliverListContent boxs">
                                        <h3 class="fontSize30 boxs">Zero In On Center Business</h3>
                                        <p class="fontSize18 boxs">Our seaward group permits associations to zero in on building and fortifying their center business regions without concentrating on employing and dealing with an IT group.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
