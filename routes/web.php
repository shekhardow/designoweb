...
Route::get('saas-website-development',[FrontController::class,'services_saas_website'])->name('front/services_saas_website');
Route::get('cms-website-development',[FrontController::class,'services_cms_website'])->name('front/services_cms_website');
Route::get('ecommerce-website-development',[FrontController::class,'services_ecommerce_website'])->name('front/services_ecommerce_website');
Route::get('custom-website-development',[FrontController::class,'services_custom_website'])->name('front/services_custom_website');
Route::get('custom-crm-development',[FrontController::class,'services_custom_crm'])->name('front/services_custom_crm');
...
Route::get('native-app-development',[FrontController::class,'services_native_apps'])->name('front/services_native_apps');
Route::get('hybrid-app-development',[FrontController::class,'services_hybrid_apps'])->name('front/services_hybrid_apps');
Route::get('tv-app-development',[FrontController::class,'services_tv_apps'])->name('front/services_tv_apps');
Route::get('wearable-app-development',[FrontController::class,'services_wearable_apps'])->name('front/services_wearable_apps');
Route::get('iot-app-development',[FrontController::class,'services_iot_apps'])->name('front/services_iot_apps');
Route::get('ar-vr-app-development',[FrontController::class,'services_ar_vr_apps'])->name('front/services_ar_vr_apps');
